...
var _404handler_1 = require("./api/middlewares/404handler");
var errorHandler_1 = require("./api/middlewares/error-handler/errorHandler");
...
app.post("/register", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userModel, user, firstname, lastname, password, newUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userModel.createUser(req.body, false)];
            case 1:
                newUser = _a.sent();
...
app.use(_404handler_1.requestNotFound404);
// handle errors
