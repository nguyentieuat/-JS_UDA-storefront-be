...
var Product = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get all products. Error: ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not get product by id. Error: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    Product.prototype.getProductByCat = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM ".concat(this.table, " WHERE category=$1");
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not get product by category. Error: ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    Product.prototype.createProduct = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var name_1, price, category, sql, conn, result, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        name_1 = product.name, price = product.price, category = product.category;
                        sql = "INSERT INTO ".concat(this.table, " (name, price, category) VALUES($1, $2, $3) RETURNING *");
                        return [4 /*yield*/, db_1.pool.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not create product. Error: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
